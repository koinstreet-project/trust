...
**Step 2)** Run `npm instal` & `npm i http-server` to get the server running. Change `words.html` to change any text in the game.

You can test things locally using [http-server](https://www.npmjs.com/package/http-server) or [MAMP](https://www.mamp.info/en/)
